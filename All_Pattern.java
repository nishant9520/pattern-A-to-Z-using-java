...
public static void main(String[] args) 
 { 
   //  java.util.Scanner put=new  java.util.Scanner(System.in);
   // System.out.println("*Pattern of alphabets A to Z using *");
   // System.out.println("*Enter only ONE Character: *");
   // char cc=put.nextChar();
   // char ch=Character.toUppercase(cc);
